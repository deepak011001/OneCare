...
export const CommonEntities = {
  ...
  policyName: {
    ...
    slotKey: 'policyName',
    label: 'Policy',
    clarifyQuestion: 'Which policy are you asking about?',
  },
  document: {
    id: 'document',
    kind: 'document',
    slotKey: 'document',
    label: 'Document',
    clarifyQuestion: 'Which document should I look up?',
  },
  department: {
    id: 'department',
    kind: 'department',
    slotKey: 'department',
    label: 'Department',
    clarifyQuestion: 'Which department?',
  },
  location: {
    id: 'location',
    kind: 'location',
    slotKey: 'location',
    label: 'Location',
    clarifyQuestion: 'Which location or office?',
  },
  benefit: {
    id: 'benefit',
    kind: 'benefit',
    slotKey: 'benefit',
    label: 'Benefit',
    clarifyQuestion: 'Which benefit — health, travel, insurance, or learning?',
  ...
  country: {
    ...
    slotKey: 'country',
    label: 'Country',
    clarifyQuestion: 'Which country’s policy should I use?',
