...
export const KNOWLEDGE_TAXONOMY: readonly TaxonomyNode[] = [
  {
    ...
    examples: ['What is our leave policy?', 'How many maternity leaves do I get?'],
  },
  {
    domain: 'hr',
    category: 'attendance',
    label: 'Attendance',
    keywords: ['attendance policy', 'work from home', 'wfh', 'hybrid', 'remote work'],
    examples: ['Can I work from home?'],
  },
  {
    domain: 'hr',
    category: 'benefits',
  ...
  },
  {
    ...
    category: 'exit',
    label: 'Exit',
    keywords: ['resignation', 'exit', 'last working day'],
    examples: ['How does resignation work?'],
  },
  {
    domain: 'hr',
    category: 'payroll',
